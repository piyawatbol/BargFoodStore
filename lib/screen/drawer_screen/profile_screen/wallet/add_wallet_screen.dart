...
import 'package:barg_store_app/widget/toast_custom.dart';
...
class AddWalletScreen extends StatefulWidget {
  String? wallet_total;
  String? wallet_id;
  AddWalletScreen({required this.wallet_id, required this.wallet_total});
...
class _AddWalletScreenState extends State<AddWalletScreen> {
  ...
  topup_wallet() async {
    ...
    final response = await http.patch(
      Uri.parse('$ipcon/topup_wallet/$user_id'),
